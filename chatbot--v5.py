...
""")
        ...
        if submit_button:
            if is_finance_related(user_question):
                ...
                # st.subheader("SQL Query Attempts")
                # for attempt_entry in sql_attempts:
                    # st.markdown(f"**Attempt {attempt_entry['attempt']}:**")
                    # st.code(attempt_entry['sql'], language="sql")

                # Display all SQL execution results
                ...
                if successful_attempt:
                    ...
                    # Add the successful SQL and result to the conversation
        ...
        if 'results' in st.session_state and 'user_question' in st.session_state:
            ...
            if user_question in st.session_state['analyses']:
                ...
                st.markdown(st.session_state['analyses'][user_question])
